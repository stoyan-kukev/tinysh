...
// Allocates memory using an initialized arena. Can call malloc to expand the
// arena.
void *arena_alloc(Arena *arena, size_t size);
// Calls arena_alloc for N count items. Zeroes the allocated memory.
...
// Frees the memory held by the arena. All pointers to previously allocated
